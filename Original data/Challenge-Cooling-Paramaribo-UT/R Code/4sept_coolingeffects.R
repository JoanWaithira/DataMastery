...
pdf(file = "DeltaTseason_revisions.pdf", paper="a4")
#Dry season
...
plotD<-ggplot(data=cooling.dry,aes(x=chrontimes))+
  ...
  scale_y_continuous(breaks=seq(-4,3, by=1))+
  expand_limits(x=0, y=0)+
  annotate(geom="label",x=12,y=2.9,label="4, 74%",
           size=2, color="dark green",)  +
  annotate(geom="label",x=9.3,y=1.85,label="8, 18%",
           size=2, color="chartreuse 4")  +
  annotate(geom="label",x=14,y=2.2,label="2, 14%",
           size=2, color="dark olive green")  +
  annotate(geom="label",x=14,y=1.5,label="22, 28%",
           size=2, color="darkolivegreen3")  +
  annotate(geom="label",x=10.75,y=0.7,label="6, 10%",
           size=2, color="chartreuse2")  +
  annotate(geom="label",x=8,y=0.75,label="12, 14%",
           size=2, color="dark cyan")  +
  annotate(geom="label",x=12.2,y=0.7,label="14, 8%",
           size=2, color="dark khaki")  +
  annotate(geom="label",x=15,y=0.7,label="18, 28%",
           size=2, color="darkgoldenrod3")  +
  annotate(geom="label",x=19.5,y=0.2,label="21, 8%",
           size=2, color="dark salmon")  +
  annotate(geom="label",x=2,y=1,label="17, 32%",
           size=2, color="brown 1")  +
  annotate(geom="label",x=5,y=1.1,label="16, 24%",
           size=2, color="darkseagreen")  +
  annotate(geom="label",x=7.5,y=(-1.9),label="15, 8%",
           size=2, color="coral4")  +
  annotate(geom="label",x=13.2,y=(-1.5),label="9, 10%",
           size=2, color="cadetblue")  +
  annotate(geom="label",x=5,y=(-1.1),label="19, 12%",
           size=2, color="burlywood3")  +
  annotate(geom="label",x=11.3,y=(-2.5),label="1, 14%",
           size=2, color="dark grey")  +
  annotate(geom="label",x=14.5,y=(-3.5),label="11, 4%",
           size=2, color="azure4")  +
  scale_color_manual(values=c(D4="dark green",D8="chartreuse 4",
                              D2="dark olive green",D22="dark olive green 3", 
                              D6="chartreuse 2",D12="dark cyan",D14="dark khaki",
...
plotW<-ggplot(data=cooling.wet,aes(x=chrontimes))+
  ...
  annotate(geom="label",x=12,y=2.9,label="4, 74%",
           size=2, color="dark green",)  +
  annotate(geom="label",x=10.5,y=2,label="8, 18%",
           size=2, color="chartreuse 4")  +
  annotate(geom="label",x=13.5,y=0.85,label="2, 14%",
           size=2, color="dark olive green")  +
  annotate(geom="label",x=13,y=1.6,label="22, 28%",
           size=2, color="darkolivegreen3")  +
  annotate(geom="label",x=11,y=0.7,label="6, 10%",
           size=2, color="chartreuse2")  +
  annotate(geom="label",x=8,y=0.4,label="12, 14%",
           size=2, color="dark cyan")  +
  annotate(geom="label",x=12.2,y=0.3,label="14, 8%",
           size=2, color="dark khaki")  +
  annotate(geom="label",x=15.5,y=0.65,label="18, 28%",
           size=2, color="darkgoldenrod3")  +
  annotate(geom="label",x=19.5,y=0,label="21, 8%",
           size=2, color="dark salmon")  +
  annotate(geom="label",x=2,y=0.7,label="17, 32%",
           size=2, color="brown 1")  +
  annotate(geom="label",x=5,y=1.1,label="16, 24%",
           size=2, color="darkseagreen")  +
  annotate(geom="label",x=15,y=(-1),label="15, 8%",
           size=2, color="coral4")  +
  annotate(geom="label",x=10.5,y=(-1.35),label="9, 10%",
           size=2, color="cadetblue")  +
  annotate(geom="label",x=5,y=(-1.1),label="19, 12%",
           size=2, color="burlywood3")  +
  annotate(geom="label",x=9,y=(-2.5),label="1, 14%",
           size=2, color="dark grey")  +
  annotate(geom="label",x=14.4,y=(-3),label="11, 4%",
           size=2, color="azure4")  +
  scale_color_manual(values=c(D4="dark green",D8="chartreuse 4",
                              D2="dark olive green",D22="dark olive green 3", 
                              D6="chartreuse 2",D12="dark cyan",D14="dark khaki",
...
multiplot<-ggarrange(plotD,plotW,labels=c("a","b"),ncol=1,nrow=2, common.legend = TRUE,
          legend = "bottom")
print(multiplot)
dev.off()
...
### create dataframe
bufferdata<-read.csv("E:/PhD/UrbanClimate paper/Analysis/R_wd/Nina/Paramaribodropsall.csv")
